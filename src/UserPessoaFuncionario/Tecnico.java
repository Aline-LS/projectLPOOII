...
public class Tecnico extends Funcionarios{
    ...
    public Tecnico(String usertyper,String usertype, String nome, String cpf, Date datanasc, String sexo) {
    ...
    public String MostrarDados(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Tecnico", "Alertaw", JOptionPane.INFORMATION_MESSAGE);
            usertype = "Tecnico";

            
            //Digite o nome
            setNome(JOptionPane.showInputDialog("Digite o nome:"));
            System.out.println("Nome Funcionário Tecnico(a): " + getNome());
            
            //Inserção do CPF e validação do mesmo
            do{
                setCpf (JOptionPane.showInputDialog("Digite o CPF" + getCpf()));
                System.out.println("CPF Funcionário Tecnico:" + getCpf());
                System.out.printf("\nResultado: ");
