 ...
 * @author Emilio
 */
public class OutroFuncionario extends Funcionarios{
    private String nome;
    private String cpf;
    private Date datanasc;
    private String sexo; 
    
    public OutroFuncionario(String usertyper,String usertype, String nome, String cpf, Date datanasc, String sexo) {
    ...
    public String MostrarDados(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "OutroFuncionario", "Alertaw", JOptionPane.INFORMATION_MESSAGE);
            usertype = "OutroFuncionario";

            
            //Digite o nome
            setNome(JOptionPane.showInputDialog("Digite o nome:"));
            System.out.println("Nome OutroFuncionario(a): " + getNome());
            
            //Inserção do CPF e validação do mesmo
            do{
                setCpf (JOptionPane.showInputDialog("Digite o CPF" + getCpf()));
                System.out.println("CPF OutroFuncionario:" + getCpf());
                System.out.printf("\nResultado: ");
