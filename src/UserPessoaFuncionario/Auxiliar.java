 ...
 * @author Emilio
 */
public class Auxiliar extends Funcionarios{
    private String nome;
    private String cpf;
    private Date datanasc;
    private String sexo; 
    
    public Auxiliar(String usertyper,String usertype, String nome, String cpf, Date datanasc, String sexo) {
    ...
    public String MostrarDados(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Auxiliar", "Alertaw", JOptionPane.INFORMATION_MESSAGE);
            usertype = "Auxiliar";

            
            //Digite o nome
            setNome(JOptionPane.showInputDialog("Digite o nome:"));
            System.out.println("Nome Funcionário Auxiliar(a): " + getNome());
            
            //Inserção do CPF e validação do mesmo
            do{
                setCpf (JOptionPane.showInputDialog("Digite o CPF" + getCpf()));
                System.out.println("CPF Funcionário Auxiliar:" + getCpf());
                System.out.printf("\nResultado: ");
